...
def rcnn_loss(scores, deltas, rcnn_labels, rcnn_targets, deltas_3dTo2D, rcnn_targets_3dTo2D):
    ...
    rcnn_smooth_l1 = modified_smooth_l1(rcnn_deltas_, rcnn_targets_, sigma=6.0)
    rcnn_reg_loss  = tf.reduce_mean(tf.reduce_sum(rcnn_smooth_l1, axis=1))
    ...
    rcnn_smooth_l1_3dTo2D = modified_smooth_l1(rcnn_deltas_3dTo2D_, rcnn_targets_3dTo2D_, sigma=6.0)
